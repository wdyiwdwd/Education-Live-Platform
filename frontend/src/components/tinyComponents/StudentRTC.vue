        ...
        <Button class="leave" :disabled="!(isJoin)" @click="leave()">结束观看</Button-->
         <div id="relative">
            <div id="toolbar" :style="toolbarStyle" v-show="isBarShown">
                ...
                <Button shape="circle" type="primary" class="buttons right" size="small" icon="ios-mic-outline" v-show="hasAudio===false" @click="enableAudio()"></Button>
                <Button shape="circle" type="primary" class="buttons right" size="small" icon="ios-mic-off" v-show="hasAudio===true" @click="disableAudio()"></Button>
            </div>
        </div>
    </div>
</template>
